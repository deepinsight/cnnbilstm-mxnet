...
class OCRIter(mx.io.DataIter):
    def __init__(self, batch_size, num_label, init_states, path, check):
        ...
        self.provide_data = [('data', (batch_size, 90 * 30))] + init_states
...
if __name__ == '__main__':
    ...
    prefix = 'mymodel/LANGUAGE_BATCH128_SEQ90_varlen_256-2-0.0005-100-mmt0.9-predhan'
    iteration = 10
    ...
    train_path  = '/data2/img_data/train_data_3_CHLang/'
    test_path  = '/data2/img_data/test_data_3_CHLang/'
