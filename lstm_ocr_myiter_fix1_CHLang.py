...
class OCRIter(mx.io.DataIter):
    def __init__(self, batch_size, num_label, init_states, path, check):
        ...
        self.provide_data = [('data', (batch_size, 32 * 32))] + init_states
...
if __name__ == '__main__':
    ...
    prefix = 'mymodel/LANGUAGE_BATCH128_SEQ32_fix1_1024-2-0.0003-100-mmt0.9-predhan'
    iteration = 10
    ...
    train_path  = '/data1/img_data/train_data_1_CHLang/'
    test_path  = '/data1/img_data/test_data_1_CHLang/'
