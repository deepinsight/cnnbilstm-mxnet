...
def get_padded_label(s,cutoff=4):
    out = np.zeros(cutoff)
...
class OCRIter(mx.io.DataIter):
    def __init__(self, batch_size, num_label, init_states, path, check):
        ...
        self.provide_data = [('data', (batch_size, 150 * 32))] + init_states
...
if __name__ == '__main__':
    ...
    prefix = 'mymodel/LANGUAGE_BATCH{bat}_SEQ{seq}_FIX4_{hid}-{nlay}-{lr}-100-mmt{mmt}-predhan'.\
    ...
    train_path  = '/data1/img_data/train_data_4_CHLang_Concat/'
    test_path  = '/data1/img_data/test_data_4_CHLang_Concat/'
